    ...
    return (
        ...
        <div className="card cardItems rounded-4 m-0 d-flex justify-content-center">
                    <div className="card-header d-flex">
                        ...
                        <button type="button" className="button2 col-2 justify-content-end">Editar mesas</button>
                    </div>
                    ...
                    <div className="card-body">
                        ...
                        <div className="mesaItems col-4 border">
                                ...
                                <button type="button" className="button2 col-8 mb-3">Editar</button>
                                <button type="button" className="button4 col-7 mb-3">Block</button>
                                <button type="button" className="button3 col-7 mb-3">Borrar</button>
                            </div>                            
                            <span type="button"className="mesaItems border d-flex align-items-center justify-content-center" data-bs-toggle="modal" data-bs-target="#exampleModal" ><h1>+</h1></span>
...
<h5 className="card-title">Mesa 02</h5>
