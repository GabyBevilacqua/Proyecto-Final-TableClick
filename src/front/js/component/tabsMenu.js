...
export const TabsMenu = () => {
  ...
  const menuData = {
    Bebidas: [
      { idProduct: "001", name: "Agua", description: "Descripción", price: "4 $", image: "IMG", quantity: 1 },
      { idProduct: "002", name: "Cerveza", description: "Descripción", price: "4 $", image: "IMG", quantity: 1 },
      { idProduct: "003", name: "Fanta", description: "Descripción", price: "4 $", image: "IMG", quantity: 1 },
      { idProduct: "004", name: "Acuarius", description: "Descripción", price: "4 $", image: "IMG", quantity: 1 },
      { idProduct: "017", name: "Cerveza 0,0", description: "Descripción", price: "4 $", image: "IMG", quantity: 1 },
      { idProduct: "018", name: "Coca-cola", description: "Descripción", price: "4 $", image: "IMG", quantity: 1 },
    ],
    Entrantes: [
